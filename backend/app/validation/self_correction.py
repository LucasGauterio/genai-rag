...
def validate_and_correct_cards(
    ...
    if accepted_cards:
        ...
        # If everything was rejected, return original with warning (or empty)
        # Choosing to return empty setup or original depending on strategy
        # Here we return original but with stats indicating failure
